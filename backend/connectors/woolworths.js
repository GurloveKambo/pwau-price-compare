 ...
 * woolworths.js
 *
 * Connector for Woolworths.
 *
 * Per MASTER_DESIGN.md's architecture note: Woolworths's live site may be
 ...
 * 4. Keep all Woolworths-specific parsing logic in this file only.
 */
...
async function search(query, retailerConfig, options = {}) {
  try {
    // Automated fetch not yet implemented for Woolworths — see note above.
