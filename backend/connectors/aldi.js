 ...
 * Connector for Aldi.
 *
 * Per MASTER_DESIGN.md's architecture note: Aldi's live site may be
 ...
 * 4. Keep all Aldi-specific parsing logic in this file only.
 */
...
async function search(query, retailerConfig, options = {}) {
  try {
    // Automated fetch not yet implemented for Aldi — see note above.
