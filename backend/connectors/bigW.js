 ...
 * Connector for Big W.
 *
 * Per MASTER_DESIGN.md's architecture note: Big W's live site may be
 ...
 * 4. Keep all Big W-specific parsing logic in this file only.
 */
...
async function search(query, retailerConfig, options = {}) {
  try {
    // Automated fetch not yet implemented for Big W — see note above.
