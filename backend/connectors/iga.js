 ...
 * Connector for IGA.
 *
 * Per MASTER_DESIGN.md's architecture note: IGA's live site may be
 ...
 * 4. Keep all IGA-specific parsing logic in this file only.
 */
...
async function search(query, retailerConfig, options = {}) {
  try {
    // Automated fetch not yet implemented for IGA — see note above.
