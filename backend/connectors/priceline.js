 ...
 * priceline.js
 *
 * Connector for Priceline.
 *
 * Per MASTER_DESIGN.md's architecture note: Priceline's live site may be
 ...
 * 4. Keep all Priceline-specific parsing logic in this file only.
 */
...
async function search(query, retailerConfig, options = {}) {
  try {
    // Automated fetch not yet implemented for Priceline — see note above.
